    ...
    <form onSubmit={save} className="space-y-6">
        ...
        <div className="sm:col-span-2">
          ...
          <div className="mt-2 flex items-center gap-3 rounded-xl border bg-muted/20 p-4">
            ...
            <p className="text-sm text-muted-foreground">
              Cole a URL da imagem da sua logo para substituir o ícone padrão no cabeçalho e no
              painel.
            </p>
          </div>
        </div>
      ...
      <Section title="Stripe (Cartão)">
        ...
        <Field
          ...
          v={f.stripe_secret_key}
          on={(v) => setF({ ...f, stripe_secret_key: v })}
        />
        <p className="sm:col-span-2 text-xs text-muted-foreground">
          Em produção, mova a Secret Key para segredo do servidor (Edge Function) e crie
          automaticamente o Price no Stripe ao salvar um produto.
        </p>
      </Section>
